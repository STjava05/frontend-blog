    ...
    <Container className="new-blog-container">
      <Form className="mt-5" onSubmit={handleSubmit}>
        ...
        <InputGroup className="mb-3">
          ...
          <Form.Control id="basic-url" aria-describedby="basic-addon3" value={blogDetailData.cover} onChange={(e) => setFormData({
            ...formData,
        ...
        <Form.Group controlId="blog-form" className="mt-3">
          ...
          <Form.Control size="lg" placeholder="Title"value={blogDetailData.title} onChange={(e) => setFormData({
             ...formData,
        ...
        <Form.Group controlId="blog-form" className="mt-3">
          ...
          <Form.Control size="lg" placeholder="Author" value={blogDetailData.name}  onChange={(e) => setFormData({
            ...formData,
        ...
        <Form.Group controlId="blog-category" className="mt-3">
          ...
          <Form.Control size="lg" as="select" value={blogDetailData.category} onChange={(e) => setFormData({
            ...formData,
        ...
        <Form.Group controlId="blog-content" className="mt-3">
          ...
          <ReactQuill value={blogDetailData.content}  onChange={handleChange} className="new-blog-content" />
        </Form.Group>
